                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-body">
                            ...
                            @php
                                $count = 0;
                                $orders = \App\Http\Controllers\OrderController::showOrdersNotDelivered();
                            @endphp
                                                ...
                                                @foreach($orders as $order)
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body" id="card">
                                                            ...
                                                            <form action="{{route("home.update", ['id' => $id])}}" method="POST">
                                                                @csrf
                                                                <div class="container justify-content-center">
                                                                    <input type="submit" class="btn btn-primary" id="add_card" value="Atendido">
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
